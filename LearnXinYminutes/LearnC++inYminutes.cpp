...
void ejemploArgumentosPorDefecto()
{
    doSomethingWithInts();
...
void ejemploIO()
{
    ...
    cout << "Tu numero favorito es " << myInt << "\n";
...
y puedes utilizarlo como era de esperar : intBox.insert(123);
...
// int main() {
//     // Este main está comentado para evitar el error
//     return 0;
// }
...
int main()
{
    ...
    {
        cout << "\n--- MENU DE EJEMPLOS C++ ---\n";
        cout << "1. Sobrecarga de funciones\n";
        cout << "2. Argumentos por defecto\n";
        cout << "3. Espacios de nombre\n";
        cout << "4. Entrada/Salida\n";
        cout << "5. Clases\n";
        cout << "6. Plantillas\n";
        cout << "0. Salir\n";
